              ...
              <div className="moreDetailsInfo">
                ...
                <div className="columns">
                  <div className="infoLeft">
                    ...
                    <p>
                      <b>Region: </b>
                      <span className="lowOpacity">{countryInfo.region}</span>
                    </p>
                    <p>
                      <b>Sub Region: </b>
                      <span className="lowOpacity">
                    ...
                    <p>
                      <b>Capital: </b>
                      <span className="lowOpacity">{countryInfo.capital}</span>
                    </p>
                  </div>
                  <div className="infoRight">
                    ...
                    <p>
                      <b>Languages: </b>
                      <span className="lowOpacity">
                        {countryInfo.languages.map((d) => (
                          <span key={d.name} className="eachLanguage">
                            {d.name},{" "}
                          </span>
                        ))}
                      </span>
                ...
                <div className="borders">
                  ...
                  <p>
                    {countryInfo.borders == null ? (
                      <p className="lowOpacity">None</p>
                    ) : (
                      countryInfo.borders.map((d) => (
                        <span key={d} className="eachBorder">
                          {d},{" "}
                        </span>
                      ))
                    )}
